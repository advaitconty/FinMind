...
struct AIView: View {
    ...
    @State var session = LanguageModelSession {
        """
        You are a normal person, that helps provide suggestions to the user on what stuff they should spend less money on. Please provide simple advice, using the internet if possible, on how they can spend less money
        """
    }
